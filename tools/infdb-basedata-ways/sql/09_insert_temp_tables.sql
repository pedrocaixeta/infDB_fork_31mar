...
INSERT INTO {output_schema}.ways_per_junction (ags, id, klasse, objektart, geom, postcode, length_geo, length_filter, length_connection_line)
SELECT
...
INSERT INTO {output_schema}.ways_per_connection (ags, id, klasse, objektart, geom, postcode, length_geo, length_filter, length_connection_line)
SELECT
  ags,                      -- municipality/region id (AGS) as text
  id,                       -- segment id as text
  klasse,                   -- feature class
...
INSERT INTO {output_schema}.connection_lines (ags, id,connected_way_id, klasse, objektart, geom, postcode, length_geo, length_filter, length_connection_line)
SELECT
  ags,                      -- municipality/region id (AGS) as text
  id,                       -- segment id as text
