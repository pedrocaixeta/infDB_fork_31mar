...
CREATE TABLE {output_schema}.buildings_heat_demand AS
    SELECT buildings.*, entise_summary."heating:demand[Wh]", buildings_to_ways.connection_geom, buildings_to_ways.endpoint_geom,
    ...
    JOIN {input_schema_ro-heat}.entise_summary ON entise_summary.building_objectid = buildings.objectid
