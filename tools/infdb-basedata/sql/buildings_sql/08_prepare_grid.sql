...
UPDATE {output_schema}.buildings_grid_{census_building_type_resolution}
...
WHERE buildings_grid_{census_building_type_resolution}.x_mp = bld.x_mp_{census_building_type_resolution}
  AND buildings_grid_{census_building_type_resolution}.y_mp = bld.y_mp_{census_building_type_resolution};
