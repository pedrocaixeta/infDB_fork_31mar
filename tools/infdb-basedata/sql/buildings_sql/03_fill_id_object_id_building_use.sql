...
INSERT INTO {output_schema}.buildings (id, feature_id, objectid, building_use, building_use_id, street, house_number, gemeindeschluessel)
SELECT b.id,
       b.feature_id,
       b.objectid,
...
WHERE NOT EXISTS (
    ...
    WHERE target.objectid = b.objectid
