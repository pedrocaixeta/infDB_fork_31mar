...
--changeset marvin.huang:1.0.3.0 labels:infdb-basedata,infdb-basedata-buildings
...
ALTER TABLE ${output_schema}.buildings ADD CONSTRAINT households_check CHECK (households >= 0);
...
-- If options below should be added, move it to a new changeset. only uncommenting will not work.
...
-- ALTER TABLE ${output_schema}.buildings ALTER COLUMN construction_year SET NOT NULL;

-- ALTER TABLE ${output_schema}.buildings ALTER COLUMN postcode SET NOT NULL;
