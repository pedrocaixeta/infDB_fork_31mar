...
#  Default: 'localhost'
c.ServerApp.ip = "0.0.0.0"  # nosec B104 # Running in container, so binding to all interfaces is okay
...
c.IdentityProvider.token = os.environ.get("SERVICES_JUPYTER_TOKEN")
...
#    'jupyter_server.services.kernels.connection.base.BaseKernelWebsocketConnection'
